...
> **v1.0 canônica** · release [`v1.0.9`](https://github.com/VIPs-com/Privacy-OS-Hub/releases/tag/v1.0.9) · B+ ✅ (validado **Tails 7.8.1**) · **Baseline teste: Tails 7.9.1** (2026-07-01) + RetoSwap **v1.8.0-reto** · [CHANGELOG](docs/CHANGELOG.md)
