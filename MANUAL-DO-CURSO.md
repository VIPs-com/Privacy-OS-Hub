...
Livro: [Curso-Tails-OS-Expert.md](Tails-OS-Expert/Curso-Tails-OS-Expert.md) · Comandos: [Playbooks/Playbooks.md](Tails-OS-Expert/Playbooks/Playbooks.md)

| Cap. | Título | Trilha README |
|------|--------|---------------|
| 1 | [Mapa do curso](Tails-OS-Expert/Curso-Tails-OS-Expert.md#1-mapa-do-curso-visão-geral) | visão geral |
| 2 | [Fundamentos do Tails](Tails-OS-Expert/Curso-Tails-OS-Expert.md#2-fundamentos-do-tails) | passo **1** |
| 3 | [Instalação do Haveno](Tails-OS-Expert/Curso-Tails-OS-Expert.md#3-instalação-e-configuração-do-haveno-na-mão) | passo **2** |
| 4 | [Segurança (exploit)](Tails-OS-Expert/Curso-Tails-OS-Expert.md#4-segurança-exploit-corrigido-na-160-reto) | passo **3** |
| 5 | [Pós-verde (carteira, backup)](Tails-OS-Expert/Curso-Tails-OS-Expert.md#5-próximos-passos-pós-verde) | passo **4** |
| 6 | [Ecossistema Monero (apêndice)](Tails-OS-Expert/Curso-Tails-OS-Expert.md#6-ecossistema-monero--tails-apêndice) | opcional |
| 7 | [FAQ — erros](Tails-OS-Expert/Curso-Tails-OS-Expert.md#7-faq--erros-possíveis-após-rodar-os-scripts) | contingência |
| 8 | [Todos os links](Tails-OS-Expert/Curso-Tails-OS-Expert.md#8-todos-os-links-referência-única) | referência |
| 9 | [Dicas e alertas finais](Tails-OS-Expert/Curso-Tails-OS-Expert.md#9-dicas-e-alertas-finais--não-cair-em-roubadas) | passo **6** (com Folheto) |
...
|--------|----------|---------------|
| A — Feather GUI | [Playbook-Feather-GUI.md](Whonix-Online/Trilha-A-Feather/Playbook-Feather-GUI.md) | passo **12** |
| B — monero-wallet-cli | [Playbook-monero-wallet-cli.md](Whonix-Online/Trilha-B-CLI/Playbook-monero-wallet-cli.md) | passo **12** |
