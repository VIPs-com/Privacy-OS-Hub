# Passo 3 — Segurança (exploit / cautela pré-trade)

| Campo | Valor |
|-------|-------|
| **Modo** | M1 · Tails + Haveno |
| **Rede** | Online (Tor) |
| **Ferramenta** | Leitura + checklist |
| **Scripts** | — (sem bash obrigatório) |
| **Log esperado** | — |
| **Não confundir com** | Passo 6 (folheto golpes) — aqui é **risco técnico** |
