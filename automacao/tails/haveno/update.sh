...
# Comando do aluno: hub.sh update
# =================================================================
###############################################################################
...
#
# NAO USE na 1a instalacao — use hub.sh install.
#
# USO:
#   ~/Persistent/hub-scripts/hub.sh update        (recomendado — lê lib/config.sh)
#   ~/Persistent/haveno-update.sh                 (legado — aceita --url e --pgp para override)
...
# Para trocar de versão: edite lib/config.sh (único lugar)
...
[ -d "$UTILS_DIR" ] || die "Haveno nao instalado ainda. Use hub.sh install (1a vez), nao hub.sh update."
g "  OK."
