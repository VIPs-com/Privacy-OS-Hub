...
> **v1.0 canônica** · release [`v1.0.10`](https://github.com/VIPs-com/Privacy-OS-Hub/releases/tag/v1.0.10) · B+ ✅ (validado **Tails 7.8.1**) · **Baseline teste: Tails 7.9.1** (2026-07-01) + RetoSwap **v1.8.0-reto** · [CHANGELOG](docs/CHANGELOG.md)
...
| 10 | Whonix + PGP | host: install → MOK → sign → verify · depois OVA PGP | "Tor Connected" no Workstation |
...
│   ├── whonix-host/                     ·  whonix-install-virtualbox.sh (+ Extension Pack + MOK)
│   │                                    ·  whonix-sign-virtualbox-modules.sh · whonix-verify-virtualbox-host.sh
