...
| Tipo | Link |
|------|------|
| Livro | [Instalar por SO](../../Whonix-Online/Instalar-Whonix-passo-a-passo-por-SO.md) |
| Comandos | [whonix-verify-image.sh](../../Whonix-Online/Scripts/whonix-verify-image.sh) · [Playbooks M2](../../Whonix-Online/Playbooks/Playbooks.md) |
