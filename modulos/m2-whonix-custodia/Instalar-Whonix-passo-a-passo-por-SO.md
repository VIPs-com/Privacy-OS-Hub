...
> **Atalho (host Linux):** [`../../automacao/whonix-host/whonix-verify-image.sh`](../../automacao/whonix-host/whonix-verify-image.sh) — baixa `derivative.asc`, confere fingerprint e verifica a imagem. Importar a VM no VirtualBox/KVM continua **manual**.
