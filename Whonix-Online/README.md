...
| **9** | Confirmar 2× cópias físicas da seed | [Curso Cap. 5](Curso-Whonix-Online.md#5-cold-tails-hot-whonix) | [qa-confirm-passo9.sh](../Tails-OS-Expert/Scripts/qa-confirm-passo9.sh) |
| **10** | Instalar Whonix + PGP (detalhe por SO no Livro) | [Instalar por SO](Instalar-Whonix-passo-a-passo-por-SO.md) | [whonix-verify-image.sh](Scripts/whonix-verify-image.sh) · [Playbooks M2](Playbooks/Playbooks.md) |
